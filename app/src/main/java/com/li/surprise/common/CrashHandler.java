...
public class CrashHandler implements UncaughtExceptionHandler {
     ...
     * @param application
     */
    public void init(GlobalApplication application) {
        app = application;
    ...
    private boolean handleException(Throwable ex) {
        ...
        new Thread() {
            ...
            public void run() {
                Looper.prepare();
//                if (app.getSysParameter().getCurRuntime() != 2) {
    ...
    public String saveCrashInfo2File(Throwable ex) {
        ...
        try {
            ...
            if (Environment.getExternalStorageState().equals(Environment.MEDIA_MOUNTED)) {
                String path = FileUtil.appStorageBootPath+"LOG"+File.separator;
                FileUtil.write(path,fileName,sb);
            }
            return fileName;
        } catch (Exception e) {
